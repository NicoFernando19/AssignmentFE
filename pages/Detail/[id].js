...
export default function Edit() {
    ...
    useEffect(() => {
        ...
        axios.get(`https://localhost:44374/api/Employees/${id}`, {
            headers: {
    ...
    const DeleteHandler = event => {
        axios.delete(`https://localhost:44374/api/Employees/${id}`, {
            headers: {
                'Authorization': `Bearer ${Token}`
            }
        }).then(response =>  {
                    ...
                    <div className="bg-white p-3 border-t-4 border-blue-400">
                        <div className="image overflow-hidden">
                            <img className="h-auto w-full mx-auto"
                                src={`https://localhost:44374/${Data.imagePath}`}
                                alt={Data.imageName} />
                        </div>
                ...
                <   div className="w-full md:w-9/12 mx-2 h-64">
                    ...
                    <div className="flex flex-wrap justify-end items-center">
                        <Link href={`/Edit/${Data.id}`}>
                            <a className="bg-blue-400 hover:bg-blue-500 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline mr-4" type="submit">
                                Edit
                            </a>
                        </Link>
